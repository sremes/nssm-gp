...
#SBATCH --output=logs/mcycle_sm_%a.log # name logs

n=$SLURM_ARRAY_TASK_ID                  # define n  
line=`sed "${n}q;d" sm_params_mcycle.txt`      # get n:th line (1-indexed) of the file 

export OMP_NUM_THREADS=8

srun -J mcycle-sm-$SLURM_ARRAY_TASK_ID python -u run-experiment.py $line
