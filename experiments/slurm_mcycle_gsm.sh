...
#SBATCH --output=logs/mcycle_gsm_%a.log # name logs

n=$SLURM_ARRAY_TASK_ID                  # define n  
line=`sed "${n}q;d" gsm_params_mcycle.txt`      # get n:th line (1-indexed) of the file 

export OMP_NUM_THREADS=8

srun -J mcycle-gsm-$SLURM_ARRAY_TASK_ID python -u run-experiment.py $line
