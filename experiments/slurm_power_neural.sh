...
#SBATCH --output=logs/power_neural_%a_0.log # name logs

n=$SLURM_ARRAY_TASK_ID                  # define n  
line=`sed "${n}q;d" neural_params_power.txt`      # get n:th line (1-indexed) of the file 

export OMP_NUM_THREADS=8

srun -J power-neural-$SLURM_ARRAY_TASK_ID python -u run-experiment.py $line
